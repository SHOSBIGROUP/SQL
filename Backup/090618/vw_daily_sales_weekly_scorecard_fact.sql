...
/****** Object:  View [sales].[vw_daily_sales_weekly_scorecard_fact]    Script Date: 9/6/2018 1:34:15 PM ******/
DROP VIEW [sales].[vw_daily_sales_weekly_scorecard_fact]
GO
...
create view [sales].[vw_daily_sales_weekly_scorecard_fact]
as
select
