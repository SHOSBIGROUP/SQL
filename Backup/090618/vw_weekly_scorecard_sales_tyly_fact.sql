...
/****** Object:  View [sales].[vw_weekly_scorecard_sales_tyly_fact]    Script Date: 9/6/2018 1:35:01 PM ******/
DROP VIEW [sales].[vw_weekly_scorecard_sales_tyly_fact]
GO
...
create view [sales].[vw_weekly_scorecard_sales_tyly_fact]
as
select
