...
/****** Object:  View [dbo].[sls_dly_trs_div_tyly_vw_new]    Script Date: 9/6/2018 1:32:49 PM ******/
DROP VIEW [dbo].[sls_dly_trs_div_tyly_vw_new]
GO
...
create view [dbo].[sls_dly_trs_div_tyly_vw_new] as 
select  bt.div_no,
 div_nm,
  cat_no,
  cat_nm,
...
comparable_last_year_calendar_dt  from 
 ...
 Product_Hierarchy_VW 
where  calendar_dt between '2018-02-04' and '2019-02-15'
and (closed_date >= '2017-01-01' or closed_date='1900-01-01')) bt
 left outer join 
   sls_dly_trs_div_fact   salesty on salesty.trs_dt=bt.calendar_dt and location=bt.pos and salesty.div_no=bt.div_no
  left outer join
     sls_dly_trs_div_fact  salesly on salesly.trs_dt=bt.comparable_last_year_calendar_dt and salesly.location=bt.pos and salesly.div_no=bt.div_no
